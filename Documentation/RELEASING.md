...
After verification, confirm the version in `Config/Release.env`, the Git tag, artifact names, and release notes match. Create the tag and GitHub Release only after the final independent audit passes.
