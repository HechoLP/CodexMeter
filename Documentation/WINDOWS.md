...
1. Download the x64 or ARM64 ZIP and `SHA256SUMS-windows.txt` from the public [`v1.0.3` GitHub release](https://github.com/HechoLP/CodexMeter-Releases/releases/tag/v1.0.3).
2. Verify the downloaded ZIP in PowerShell:

   ```powershell
   Get-FileHash .\CodexMeter-Windows-1.0.3-x64.zip -Algorithm SHA256
